...
import org.apache.jena.query.text.TemporalIndexChronix;
...
public class TestTemporalIndexImplAssembler extends AbstractTestTemporalAssembler {
    
    @Test public void testIndexHasEntityMap() {
        TemporalIndexChronix index = (TemporalIndexChronix) Assembler.general.open(SIMPLE_INDEX_SPEC);
        try {
    ...
    @Test public void testLiteralDirectory() {
        ...
        // a literal
        TemporalIndexChronix index = (TemporalIndexChronix)assembler.open(a, root, /*mode*/ null);
        try {
            assertNotNull(index);
        }
        finally {
    ...
    @Test public void testQueryAnalyzer() {
        TemporalIndexChronix index = (TemporalIndexChronix) Assembler.general.open(SIMPLE_INDEX_SPEC_QUERY_ANALYZER);
        try {
