...
public class TestDatasetWithAnalyzingQueryParser extends TestDatasetWithConfigurableAnalyzer {
    ...
    public void before() {
        init(StrUtils.strjoinNL(
            "temporal:ConfigurableAnalyzer ;",
            "temporal:tokenizer temporal:KeywordTokenizer ;",
            "temporal:filters (temporal:ASCIIFoldingFilter temporal:LowerCaseFilter)"
        ), "temporal:AnalyzingQueryParser");
    }    
    ...
    public void testAnalyzingQueryParserAnalyzesWildcards() {
        ...
        String queryString = StrUtils.strjoinNL(
                ...
                "SELECT ?s",
                "WHERE {",
                "    ?s temporal:query ( rdfs:label 'édu*' 10 ) .",
                "}"
                );
