...
public class TestLuceneWithMultipleThreads
{
    ...
    {
        final DatasetGraphText dsg = (DatasetGraphText) TemporalDatasetFactory.createLucene(DatasetGraphFactory.create(), new RAMDirectory(), new TemporalIndexConfig(entDef));
                    ...
                    while (!Thread.interrupted()) {
                        ...
                        try {
                            QueryExecution qExec = QueryExecutionFactory.create(
                                    "select * where { graph <http://example.org/graph> { ?s <" + TemporalVocab.pfQuery + "> (<" + RDFS.label.getURI() + "> \"test\") } }", ds);
