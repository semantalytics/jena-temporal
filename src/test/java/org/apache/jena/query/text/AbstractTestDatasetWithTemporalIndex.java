 ...
 * the actual tests.
 */
public abstract class AbstractTestDatasetWithTemporalIndex extends AbstractTestDatasetWithTextIndexBase {
    ...
    public void testOneSimpleResult() {
        ...
        String queryString = StrUtils.strjoinNL(
                ...
                "SELECT ?s",
                "WHERE {",
                "    ?s temporal:query ( rdfs:label 'testOneSimpleResult' 10 ) .",
                "}"
                );
    ...
    public void propertyFunctionText_1() {
        ...
        String queryString = StrUtils.strjoinNL(
                ...
                "SELECT ?s",
                "WHERE {",
                "    ?s temporal:query (rdfs:label  'temporal') .",
                "}"
                );
        Set<String> expectedURIs = new HashSet<>();
    ...
    public void propertyFunctionText_1_score() {
        ...
        String queryString = StrUtils.strjoinNL(
                ...
                "SELECT ?s ?score",
                "WHERE {",
                "    (?s ?score) temporal:query ('temporal') .",
                "}"
                );
    ...
    public void propertyFunctionText_4() {
        ...
        String queryString = StrUtils.strjoinNL(
                ...
                "WHERE {",
                "    ?s rdfs:label 'temporal' .",
                "    ?s temporal:query ( rdfs:label 'fuzz') .",
                "}"
                );
        Set<String> expectedURIs = new HashSet<>();
        doTestSearch(turtle, queryString, expectedURIs);
    ...
    public void propertyFunctionText_7() {
        ...
        String queryString = StrUtils.strjoinNL(
                ...
                "WHERE {",
                "    BIND(1 AS ?C)", 
                "    ?s temporal:query ( rdfs:label 'temporal' ?C) .",
                "}"
                );
        Set<String> expectedURIs = new HashSet<>();
        expectedURIs.addAll( Arrays.asList( R_S1 ) ) ;
    ...
    public void testMultipleResults() {
        ...
        String queryString = StrUtils.strjoinNL(
                ...
                "SELECT ?s",
                "WHERE {",
                "    ?s temporal:query ( rdfs:label '" + label + "?' 10 ) .",
                "}"
                );
        Set<String> expectedURIs = new HashSet<>() ;
    ...
    public void testMultipleResults_score() {
        ...
        String queryString = StrUtils.strjoinNL(
                ...
                "SELECT ?s ?score",
                "WHERE {",
                "    (?s ?score) temporal:query ( rdfs:label 'brown fox' 10 ) .",
                "}"
                );
        Set<String> expectedURIs = new HashSet<>();
        expectedURIs.addAll( Arrays.asList(
    ...
    public void testSearchCorrectField() {
        ...
        String queryStringComment = StrUtils.strjoinNL(
                ...
                "SELECT ?s",
                "WHERE {",
                "    ?s temporal:query ( rdfs:comment '" + label + "?' 10 ) .",
                "}"
                );
