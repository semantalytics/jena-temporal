...
public class TestTextGraphIndexExtra {
    ...
    static Dataset textDataset(Dataset dataset) {
        ...
        TemporalIndex temporalIndex = TemporalDatasetFactory.createLuceneIndex(new RAMDirectory(), new TemporalIndexConfig(entdef));
        return TemporalDatasetFactory.create(dataset, temporalIndex, true);
    }
