...
public abstract class AbstractTestTemporalAssembler {
    ...
    static {
        SIMPLE_ENTITY_MAP_SPEC = 
                model.createResource(TESTBASE + "simpleEntityMapSpec")
                     .addProperty(RDF.type, TemporalVocab.entityMap)
                     .addProperty(TemporalVocab.pEntityField, "entityField")
                     .addProperty(TemporalVocab.pDefaultField, "defaultField")
                     .addProperty(TemporalVocab.pMap,
                                  model.createList(
                                          new RDFNode[] {
                                                model.createResource()
                                                     .addProperty(TemporalVocab.pField, "defaultField")
                                                     .addProperty(TemporalVocab.pPredicate, RDFS.label)
                                          }))
                     ;
        SIMPLE_DATASET_SPEC =
        ...
        SIMPLE_INDEX_SPEC =
                model.createResource(TESTBASE + "simpleIndexSpec")
                     .addProperty(RDF.type, TemporalVocab.textIndexLucene)
                     .addProperty(TemporalVocab.pDirectory, model.createResource("file:target/test/testasm/simpleIndexSpec"))
                     .addProperty(TemporalVocab.pEntityMap, SIMPLE_ENTITY_MAP_SPEC);
        
        SIMPLE_INDEX_SPEC2 =
                model.createResource(TESTBASE + "simpleIndexSpec2")
                     .addProperty(RDF.type, TemporalVocab.textIndexLucene)
                     .addProperty(TemporalVocab.pDirectory, model.createResource("file:target/test/testasm/simpleIndexSpec2"))
                     .addProperty(TemporalVocab.pEntityMap, SIMPLE_ENTITY_MAP_SPEC);
        
        SIMPLE_INDEX_SPEC3 =
                model.createResource(TESTBASE + "simpleIndexSpec3")
                     .addProperty(RDF.type, TemporalVocab.textIndexLucene)
                     .addProperty(TemporalVocab.pDirectory, model.createResource("file:target/test/testasm/simpleIndexSpec3"))
                     .addProperty(TemporalVocab.pEntityMap, SIMPLE_ENTITY_MAP_SPEC);
        
        SIMPLE_INDEX_SPEC4 =
                model.createResource(TESTBASE + "simpleIndexSpec4")
                     .addProperty(RDF.type, TemporalVocab.textIndexLucene)
                     .addProperty(TemporalVocab.pDirectory, model.createResource("file:target/test/testasm/simpleIndexSpec4"))
                     .addProperty(TemporalVocab.pEntityMap, SIMPLE_ENTITY_MAP_SPEC);
        
        SIMPLE_INDEX_SPEC5 =
                model.createResource(TESTBASE + "simpleIndexSpec5")
                .addProperty(RDF.type, TemporalVocab.textIndexLucene)
                .addProperty(TemporalVocab.pDirectory, model.createResource("file:target/test/testasm/simpleIndexSpec5"))
                .addProperty(TemporalVocab.pEntityMap, SIMPLE_ENTITY_MAP_SPEC);
        
        SIMPLE_INDEX_SPEC_QUERY_ANALYZER =
                model.createResource(TESTBASE + "simpleIndexSpecQueryAnalyzer")
                     .addProperty(RDF.type, TemporalVocab.textIndexLucene)
                     .addProperty(TemporalVocab.pDirectory, model.createResource("file:target/test/testasm/simpleIndexSpecQueryAnalyzer"))
                     .addProperty(TemporalVocab.pQueryAnalyzer,
                         model.createResource().addProperty(RDF.type, TemporalVocab.keywordAnalyzer)
                     )
                     .addProperty(TemporalVocab.pEntityMap, SIMPLE_ENTITY_MAP_SPEC);
        ...
        SIMPLE_INDEX_SPEC_LITERAL_DIR =
                model.createResource(TESTBASE + "simpleIndexLiteralDirSpec")
                     .addProperty(RDF.type, TemporalVocab.textIndexLucene)
                     .addProperty(TemporalVocab.pDirectory, model.createLiteral("target/test/testasm/simpleIndexLiteralDir"))
                     .addProperty(TemporalVocab.pEntityMap, SIMPLE_ENTITY_MAP_SPEC);

        SIMPLE_INDEX_SPEC_MEM_DIR =
                model.createResource(TESTBASE + "simpleIndexMemDirSpec")
                     .addProperty(RDF.type, TemporalVocab.textIndexLucene)
                     .addProperty(TemporalVocab.pDirectory, model.createLiteral("mem"))
                     .addProperty(TemporalVocab.pEntityMap, SIMPLE_ENTITY_MAP_SPEC);
    }
