 ...
 */
public class AbstractTestDatasetWithLuceneTemporalIndexDeletionSupport extends AbstractTestDatasetWithTemporalIndex {
    ...
    public void init() {
        ...
        dataset = TemporalDatasetFactory.create(ds1, tidx) ;
    }
