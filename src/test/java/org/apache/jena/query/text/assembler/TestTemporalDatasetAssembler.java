...
/**
 * Test the temporal dataset assembler.
 */
public class TestTemporalDatasetAssembler extends AbstractTestTemporalAssembler {
    ...
    public void testSimpleDatasetAssembler() {
        ...
        assertTrue(dataset.getContext().get(TextQuery.textIndex) instanceof TemporalIndexLucene);
    }
    ...
    public void testCustomTextDocProducer() {
        ...
        assertTrue(dsgText.getMonitor() instanceof CustomTemporalDocProducer) ;
        dataset.close();
    }
    ...
    public void testCustomTextDocProducerDyadicConstructor() {
        ...
        DatasetGraphText dsgText = (DatasetGraphText)dataset.asDatasetGraph() ;
        assertTrue(dsgText.getMonitor() instanceof CustomDyadicTemporalDocProducer) ;
    ...
    static {
        ...
        spec1 =
            model.createResource(TESTBASE + "spec1")
                 .addProperty(RDF.type, TemporalVocab.textDataset)
                 .addProperty(TemporalVocab.pDataset, SIMPLE_DATASET_SPEC)
                 .addProperty(TemporalVocab.pIndex, SIMPLE_INDEX_SPEC3);
        noDatasetPropertySpec =
            model.createResource(TESTBASE + "noDatasetPropertySpec")
                 .addProperty(RDF.type, TemporalVocab.textDataset)
                 .addProperty(TemporalVocab.pIndex, SIMPLE_INDEX_SPEC4);
        noIndexPropertySpec =
        ...
        customTextDocProducerSpec =
            model.createResource(TESTBASE + "customTextDocProducerSpec")
                 .addProperty(RDF.type, TemporalVocab.textDataset)
                 .addProperty(TemporalVocab.pDataset, SIMPLE_DATASET_SPEC)
                 .addProperty(TemporalVocab.pIndex, SIMPLE_INDEX_SPEC5)
                 .addProperty(TemporalVocab.pTextDocProducer, model.createResource("java:org.apache.jena.query.temporal.assembler.TestTextDatasetAssembler$CustomTextDocProducer"));
        ...
        customDyadicTextDocProducerSpec =
            model.createResource(TESTBASE + "customDyadicTextDocProducerSpec")
                 ...
                 .addProperty(TemporalVocab.pDataset, SIMPLE_DATASET_SPEC)
                 .addProperty(TemporalVocab.pIndex, SIMPLE_INDEX_SPEC5)
                 .addProperty(TemporalVocab.pTextDocProducer, model.createResource("java:org.apache.jena.query.temporal.assembler.TestTextDatasetAssembler$CustomDyadicTextDocProducer"));
    }

    private static class CustomTemporalDocProducer implements TemporalDocProducer {

        public CustomTemporalDocProducer(TemporalIndex temporalIndex) { }
    ...
    private static class CustomDyadicTemporalDocProducer implements TemporalDocProducer {

        final DatasetGraph dg;
        Node lastSubject = null;

        public CustomDyadicTemporalDocProducer(DatasetGraph dg, TemporalIndex temporalIndex) {
            this.dg = dg;
        }
