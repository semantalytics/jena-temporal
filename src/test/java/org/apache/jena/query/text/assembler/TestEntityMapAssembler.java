...
public class TestEntityMapAssembler {
    ...
    @Test(expected= TemporalIndexException.class) public void errorOnNoEntityField() {
        EntityDefinitionAssembler entDefAssem = new EntityDefinitionAssembler();
        entDefAssem.open(null, specNoEntityField, null);
    }
    
    @Test(expected= TemporalIndexException.class) public void errorOnNoDefaultField() {
        EntityDefinitionAssembler entDefAssem = new EntityDefinitionAssembler();
        entDefAssem.open(null, specNoDefaultField, null);
    }
    
    @Test(expected= TemporalIndexException.class) public void errorOnNoMapProperty() {
        EntityDefinitionAssembler entDefAssem = new EntityDefinitionAssembler();
        entDefAssem.open(null, specNoMapProperty, null);
    }
    
    @Test(expected= TemporalIndexException.class) public void errorOnNoPrimaryFieldDef() {
        EntityDefinitionAssembler entDefAssem = new EntityDefinitionAssembler();
        try {
            entDefAssem.open(null, specNoPrimaryFieldDef, null);
        } catch (TemporalIndexException e) {
    ...
    static {
        ...
        spec1 = model.createResource(TESTBASE + "spec1")
                     .addProperty(TemporalVocab.pEntityField, SPEC1_ENTITY_FIELD)
                     .addProperty(TemporalVocab.pDefaultField, SPEC1_DEFAULT_FIELD)
                     .addProperty(TemporalVocab.pMap,
                                  model.createList(
                                          new RDFNode[] {
                                                model.createResource()
                                                     .addProperty(TemporalVocab.pField, SPEC1_DEFAULT_FIELD)
                                                     .addProperty(TemporalVocab.pPredicate, SPEC1_PREDICATE)
                                          }))
                     ;
        ...
        spec2 = model.createResource(TESTBASE + "spec2")
                     .addProperty(TemporalVocab.pEntityField, SPEC2_ENTITY_FIELD)
                     .addProperty(TemporalVocab.pDefaultField, SPEC2_DEFAULT_FIELD)
                     .addProperty(TemporalVocab.pMap,
                                  model.createList(
                                          new RDFNode[] {
                                                model.createResource()
                                                     .addProperty(TemporalVocab.pField, SPEC2_DEFAULT_FIELD)
                                                     .addProperty(TemporalVocab.pPredicate, SPEC2_PREDICATE1),
                                                model.createResource()
                                                     .addProperty(TemporalVocab.pField, SPEC2_FIELD2)
                                                     .addProperty(TemporalVocab.pPredicate, SPEC2_PREDICATE2),
                                          ...
                                          model.createList(
                                                  new RDFNode[] {
                                                        model.createResource()
                                                             .addProperty(TemporalVocab.pField, SPEC1_DEFAULT_FIELD)
                                                             .addProperty(TemporalVocab.pPredicate, SPEC1_PREDICATE)
                                                             .addProperty(TemporalVocab.pAnalyzer,
                                                                          model.createResource()
                                          ...
                                          model.createList(
                                                  new RDFNode[] {
                                                        model.createResource()
                                                             ...
                                                             .addProperty(TemporalVocab.pAnalyzer,
                                                                          model.createResource()
                                                                               .addProperty(RDF.type, TemporalVocab.standardAnalyzer))
                                                                               .addProperty(TemporalVocab.pStopWords, toList(model, "and the but"))
                                                  }));        
        // create a simple entity map specification using a keyword analyzer
                                          ...
                                          model.createList(
                                                  new RDFNode[] {
                                                        model.createResource()
                                                             ...
                                                             .addProperty(TemporalVocab.pAnalyzer,
                                                                          model.createResource()
                                                                               .addProperty(RDF.type, TemporalVocab.keywordAnalyzer))
                                                  }));
                                          ...
                                          model.createList(
                                                  new RDFNode[] {
                                                        model.createResource()
                                                             ...
                                                             .addProperty(TemporalVocab.pAnalyzer,
                                                                          model.createResource()
                                                                               .addProperty(RDF.type, TemporalVocab.lowerCaseKeywordAnalyzer))
                                                  }));
                                          ...
                                          model.createList(
                                                  new RDFNode[] {
                                                        model.createResource()
                                                             ...
                                                             .addProperty(TemporalVocab.pAnalyzer,
                                                                          model.createResource()
                                                                               .addProperty(RDF.type, TemporalVocab.configurableAnalyzer)
                                                                               .addProperty(TemporalVocab.pTokenizer, TemporalVocab.standardTokenizer))
                                                  }));
                ...
                model.createResource(TESTBASE + "noPrimaryFieldDef")
                     ...
                     .addProperty(TemporalVocab.pMap,
                                  model.createList(
                                          new RDFNode[] {
                                                model.createResource()
                                                     .addProperty(TemporalVocab.pField, SPEC1_ENTITY_FIELD)
                                                     .addProperty(TemporalVocab.pPredicate, SPEC1_PREDICATE)
                                          }))
                     ;
    }
