...
public class TestDatasetWithLuceneTemporalIndexDeletionSupport extends AbstractTestDatasetWithLuceneTemporalIndexDeletionSupport {
    ...
    public void testInsertDeleteOneTriple(){
        ...
        String queryString = StrUtils.strjoinNL(
                ...
                "SELECT ?s",
                "WHERE {",
                "    ?s temporal:query ( rdfs:label 'first' ) .",
                "}"
        );
    ...
    public void testInsert2WithSameLabelAndDelete1(){
        ...
        String queryString = StrUtils.strjoinNL(
                ...
                "SELECT ?s",
                "WHERE {",
                "    ?s temporal:query ( rdfs:label 'same' ) .",
                "}"
        );
        Set<String> expectedURIs = new HashSet<>() ;
