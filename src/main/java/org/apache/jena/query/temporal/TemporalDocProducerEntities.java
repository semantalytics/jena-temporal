...
public class TemporalDocProducerEntities extends DatasetChangesBatched implements TemporalDocProducer {
    private static Logger          log     = LoggerFactory.getLogger(TemporalDocProducer.class) ;
    private final EntityDefinition defn ;
    private final TemporalIndex indexer ;
    ...
    public TemporalDocProducerEntities(TemporalIndex indexer) {
    ...
    private void docEntity(Node g, Node s, List<Quad> batch) {
        ...
        String gx = TemporalQueryFuncs.graphNodeToString(g) ;
    ...
    private void docQuads(List<Quad> batch) {
        ...
        for ( Quad quad : batch ) {
            Entity entity = TemporalQueryFuncs.entityFromQuad(defn, quad) ;
            if ( entity != null )
                indexer.addEntity(entity) ;
        }
    }
