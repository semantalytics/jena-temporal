...
public class TemporalIndexParseException extends QueryParseException
{
...
//    public TextIndexParseException(String textQuery, Throwable cause) { super(message(textQuery,null), cause,-1,-1) ; }
    public TemporalIndexParseException(String textQuery, String msg) { super(message(textQuery,msg),-1,-1) ; }
    public TemporalIndexParseException(String textQuery, String msg, Throwable cause) { super(message(textQuery,msg), cause,-1,-1) ; }
    ...
    private static String message(String textQuery, String errorMessage) {
        ...
        String msg = ( errorMessage == null )
            ? "Text search parse error: temporal query '"+textQuery+"'"
