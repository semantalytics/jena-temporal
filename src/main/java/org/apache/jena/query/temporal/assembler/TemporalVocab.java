...
public class TemporalVocab
{
    public static final String NS                   =  "http://jena.apache.org/temporal#" ;
    
    public static final String pfQuery              =  NS+"query" ;

    public static final Resource temporalDataset        = Vocab.resource(NS, "TemporalDataset") ;
    ...
    public static final Property pTemporalDocProducer   = Vocab.property(NS, "temporalDocProducer") ;
    
    public static final Resource temporalIndex          = Vocab.resource(NS, "TemporalIndex") ;
    public static final Resource temporalIndexLucene    = Vocab.resource(NS, "TemporalIndexLucene") ;
